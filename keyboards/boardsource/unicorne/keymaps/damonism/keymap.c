...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	// -------------------------------------------------------------------------------------
        ...
        [3] = LAYOUT_split_3x6_3(
	      ...
	      QK_RBT,  KC_TRNS, KC_TRNS, UG_SPDU, UG_VALU, KC_TRNS,   KC_VOLU, KC_BRIU, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
	      KC_TRNS, KC_TRNS, UG_TOGG, UG_SPDD, UG_VALD, KC_TRNS,   KC_VOLD, KC_BRID, KC_MPRV, KC_MNXT, KC_TRNS, KC_TRNS,
